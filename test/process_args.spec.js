...
process.argv.push("", "", "--test", `"test value"`, "--value", "uncaptured  ", "-abt", "timeout", "./dir", "--data", "=./data/dir", "../file/path", "./another/file/path/**/*.js");
...
assert(
    ...
    args.trailing_arguments == ["../file/path", "./another/file/path/**/*.js"]
);
